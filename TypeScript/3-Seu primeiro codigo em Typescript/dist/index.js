...
function accelerate(targetSpeed, spaceship) {
    if (spaceship.speed > targetSpeed) {
        alert("Reduzinho a velocidade da ".concat(spaceship.name, " para ").concat(targetSpeed, "..."));
    }
    else if (spaceship.speed < targetSpeed) {
        alert("Aumentando a velocdade da ".concat(spaceship.name, " para ").concat(targetSpeed, "..."));
    }
    else {
...
var currentShip = sendSpaceship(spaceshipName, spaceshipCapitain);
